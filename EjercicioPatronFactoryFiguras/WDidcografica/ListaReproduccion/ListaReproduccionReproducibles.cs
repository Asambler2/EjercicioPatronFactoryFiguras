...
{
    public class ListaReproduccionReproducibles : IListaReproduccion
    {
        ...
        {
            Console.WriteLine($"La lista de reproducción dura: {this.DuracionTotalLista} y tiene {this.CantidadDeReproducibles} reproducibles");
            return "$\"La lista de reproducción dura: {this.DuracionTotalLista} y tiene {this.CantidadDeReproducibles} reproducibles\"";
        }
    }
}
